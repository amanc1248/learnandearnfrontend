    ...
    <div className="row home_screen_firstPart">
      <div className="col-lg-6 col-12">
        ...
        <div className="homeScreen__courseOverview__list">
          <ul>
            <li>1-on-1 coding classes tailored to your kid's skill-level and interests.</li>
            <li>Expert teachers that kids love.</li>
            <li>Learn to code real-world projects like games, apps and animations.</li>
          </ul>
        </div>
        <div className="enroll__for__free__button button__width">
